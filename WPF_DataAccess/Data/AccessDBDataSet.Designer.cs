            ...
            public int Age {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Age\' в таблице \'Person\' равно DBNull.", e);
                    }
                }
                set {
...
namespace WPF_DataAccess.Data.AccessDBDataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Person` WHERE ((`ID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR (`" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Person` (`FirstName`, `LastName`, `Age`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Person` SET `FirstName` = ?, `LastName` = ?, `Age` = ? WHERE ((`ID` = ?) " +
                "AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AND ((? = 1 AND `Last" +
                "Name` IS NULL) OR (`LastName` = ?)) AND ((? = 1 AND `Age` IS NULL) OR (`Age` = ?" +
                ")))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WPF_DataAccess.Properties.Settings.Default.connStrAccessDB;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FirstName, LastName, Age FROM Person";
        ...
        public virtual int Fill(AccessDBDataSet.PersonDataTable dataTable) {
        ...
        public virtual AccessDBDataSet.PersonDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AccessDBDataSet.PersonDataTable dataTable = new AccessDBDataSet.PersonDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AccessDBDataSet.PersonDataTable dataTable) {
